...
class bd_egisso:
    ...
    def bd(self):
        con = sqlite3.connect('egisso_db_Maloobespechenka')
    ...
    def tabal_import(self):
      ...
      stek_fact = ["Fact",
              "110889af-5b84-4f8f-8add-6eabea4f4ad8",
              "a3798b85-6a49-4f1b-aa2c-3be2b2e0a759",
              "6706.000000",
              lineEdit,
              lineEdit_2,
              lineEdit_3,
    ...
    def export_bd(self):
        ...
        with open("export-bd/egisso_db_Maloobespechenka.csv", 'w', newline='') as csvfile:
    ...
    def import_csv_bd(self):
        ...
        with open("import-bd/test.csv", newline='') as csvfile:
            ...
            for row in reader:
                ...
                cur.execute("""UPDATE fact SET LMSZID='110889af-5b84-4f8f-8add-6eabea4f4ad8',
                categoryID='a3798b85-6a49-4f1b-aa2c-3be2b2e0a759',
